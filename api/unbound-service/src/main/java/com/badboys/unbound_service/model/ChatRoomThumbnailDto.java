...
public class ChatRoomThumbnailDto {
    ...
    @Schema(description = "경기일시", example = "2025-01-01 12:00")
    ...
    public ChatRoomThumbnailDto(Long chatRoomId, String name, int memberCnt, Long regionId, String matchDt, Double averageMmr) {
