...
public interface ChatMessageRepository extends MongoRepository<ChatMessageDocument, String> {
    ...
    int countByChatRoomIdAndChatMessageIdGreaterThan(Long chatRoomId, Long lastReadMessageId);
    ...
    List<ChatMessageDocument> findTop20ByChatRoomIdAndChatMessageIdLessThanOrderByCreatedAtDesc(Long chatRoomId, Long lastMessageId);
}
